...
| [7_ui-audit](7_ui-audit.md) | Web accessibility, responsive capture flow, reviewed bill attachments | Keep web zoom enabled, keep long capture sheets scrollable, and upload bill documents only after the user saves the reviewed record. |
| [8_schema-repair-and-greeting](8_schema-repair-and-greeting.md) | Vendor/customer phone schema repair and dashboard copy | Keep party phone columns present in Supabase so the mobile relation selects remain valid; keep the dashboard header compact. |
