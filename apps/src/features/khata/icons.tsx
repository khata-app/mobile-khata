...
export function GridIcon(props: IconProps) {
  return <Icon {...props}><Rect x="3" y="3" width="7" height="7" rx="1" /><Rect x="14" y="3" width="7" height="7" rx="1" /><Rect x="14" y="14" width="7" height="7" rx="1" /><Rect x="3" y="14" width="7" height="7" rx="1" /></Icon>;
}
...
export function ArrowUpRightIcon(props: IconProps) {
  return <Icon {...props}><Line x1="7" y1="17" x2="17" y2="7" /><Polyline points="7 7 17 7 17 17" /></Icon>;
}

export function MoreIcon(props: IconProps) {
  return <Icon {...props}><Circle cx="12" cy="12" r="1" fill="#3A2C1E" stroke="none" /><Circle cx="19" cy="12" r="1" fill="#3A2C1E" stroke="none" /><Circle cx="5" cy="12" r="1" fill="#3A2C1E" stroke="none" /></Icon>;
}
...
export function LedgerIcon(props: IconProps) {
  return <Icon {...props}><Path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20" /><Path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z" /><Line x1="9" y1="7" x2="15" y2="7" /><Line x1="9" y1="11" x2="15" y2="11" /></Icon>;
}
...
export function BoxIcon(props: IconProps) {
  return <Icon {...props}><Path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z" /><Polyline points="3.27 6.96 12 12.01 20.73 6.96" /><Line x1="12" y1="22.08" x2="12" y2="12" /></Icon>;
}
...
export function SunIcon(props: IconProps) {
  return <Icon {...props}><Circle cx="12" cy="12" r="5" /><Line x1="12" y1="1" x2="12" y2="3" /><Line x1="12" y1="21" x2="12" y2="23" /><Line x1="4.22" y1="4.22" x2="5.64" y2="5.64" /><Line x1="18.36" y1="18.36" x2="19.78" y2="19.78" /><Line x1="1" y1="12" x2="3" y2="12" /><Line x1="21" y1="12" x2="23" y2="12" /><Line x1="4.22" y1="19.78" x2="5.64" y2="18.36" /><Line x1="18.36" y1="5.64" x2="19.78" y2="4.22" /></Icon>;
}

export function GearIcon(props: IconProps) {
  return <Icon {...props}><Circle cx="12" cy="12" r="3" /><Path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1z" /></Icon>;
}
...
export function CreditCardIcon(props: IconProps) {
  return <Icon {...props}><Rect x="1" y="4" width="22" height="16" rx="2" ry="2" /><Line x1="1" y1="10" x2="23" y2="10" /></Icon>;
}

export function CoinsIcon(props: IconProps) {
  return <Icon {...props}><Line x1="12" y1="1" x2="12" y2="23" /><Path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6" /></Icon>;
}

export function PercentIcon(props: IconProps) {
  return <Icon {...props}><Line x1="19" y1="5" x2="5" y2="19" /><Circle cx="6.5" cy="6.5" r="2.5" /><Circle cx="17.5" cy="17.5" r="2.5" /></Icon>;
}

export function CartIcon(props: IconProps) {
  return <Icon {...props}><Circle cx="9" cy="21" r="1" /><Circle cx="20" cy="21" r="1" /><Path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6" /></Icon>;
}
...
export function TrashIcon(props: IconProps) {
  return <Icon {...props}><Polyline points="3 6 5 6 21 6" /><Path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2" /><Line x1="10" y1="11" x2="10" y2="17" /><Line x1="14" y1="11" x2="14" y2="17" /></Icon>;
}

export function BuildingIcon(props: IconProps) {
  return <Icon {...props}><Path d="M6 22V4a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v18Z" /><Path d="M6 12H4a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h2" /><Path d="M18 9h2a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2h-2" /><Path d="M10 6h4" /><Path d="M10 10h4" /><Path d="M10 14h4" /><Path d="M10 18h4" /></Icon>;
}

export function ScaleIcon(props: IconProps) {
  return <Icon {...props}><Path d="m16 16 3-8 3 8c-.87.65-1.92 1-3 1s-2.13-.35-3-1Z" /><Path d="m2 16 3-8 3 8c-.87.65-1.92 1-3 1s-2.13-.35-3-1Z" /><Path d="M7 21h10" /><Path d="M12 3v18" /><Path d="M3 7h2c2 0 5-1 7-2 2 1 5 2 7 2h2" /></Icon>;
}

export function ReceiptIcon(props: IconProps) {
  return <Icon {...props}><Path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1Z" /><Path d="M14 8H8" /><Path d="M16 12H8" /><Path d="M13 16H8" /></Icon>;
}
...
export function WalletIcon(props: IconProps) {
  return <Icon {...props}><Path d="M20 12V8H6a2 2 0 0 1 0-4h14v4" /><Path d="M4 6v12a2 2 0 0 0 2 2h14v-4" /><Path d="M18 12a2 2 0 0 0 0 4h4v-4Z" /></Icon>;
}

export function ShieldIcon(props: IconProps) {
  return <Icon {...props}><Path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" /><Polyline points="9 12 11 14 15 10" /></Icon>;
}
...
export function BanknoteIcon(props: IconProps) {
  return <Icon {...props}><Rect x="2" y="6" width="20" height="12" rx="2" ry="2" /><Circle cx="12" cy="12" r="2" /><Path d="M6 12h.01M18 12h.01" /></Icon>;
}
