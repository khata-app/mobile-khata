...
const styles = StyleSheet.create({
  ...
  mobileHeader: { flexDirection: 'row', alignItems: 'center', gap: 10, paddingHorizontal: 14, paddingVertical: 10, backgroundColor: C.paperLight, borderBottomColor: C.border, borderBottomWidth: 1 },
  ...
  mobileNav: { flexDirection: 'row', backgroundColor: C.paperLight, borderTopColor: C.border, borderTopWidth: 1, paddingBottom: 7, paddingTop: 7 },
